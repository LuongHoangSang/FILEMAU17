...
\def\cao{2}
\titlespacing{\chapter}{0cm}{0.5cm}{1.3cm}[0cm] %1: , 2: Trên, 3: dưới
\titleformat{\chapter}
...
%\def\mauphaibai{cyan}
\def\tenlop{Lớp Toán thầy Thịnh}
\def\slogan{UY TÍN -- CHẤT LƯỢNG -- HIỆU QUẢ}
%
...
{%	
	...
	\begin{tikzpicture}%[line join=round,line cap=round]
		...
		%-- tên lớp và slogan
		\draw[\mautraibai, line width=2pt] ([yshift=0.45cm,xshift=-\dddd cm+11pt]secname.north west) coordinate (loptoan) --++(\textwidth-3pt,0);
		\node[anchor=west, text=\mautraibai, fill=white, inner sep=0pt,scale=1.1] at ([xshift=-2pt]loptoan){
			\usefont{T5}{HLBrush2BK}{m}{n}\tenlop: ~%
		};
		\node[anchor=center, text=\mautraibai, fill=white, inner sep=3pt] at  ([yshift=0.45cm,xshift=-0.5*\textwidth+0.5*\dddd cm]secname.north east) {%
...
\renewenvironment{mydn}{
	\stepcounter{mydn}\noindent\khungMT{\maudn}{\iconVD Định nghĩa \themydn}%
}{}
\renewenvironment{mydl}{
	\stepcounter{mydl}\noindent\khungMT{\maudl}{\iconVD Định lí \themydl}%
}{}
\renewenvironment{mytc}{
	\stepcounter{mytc}\noindent\khungMT{\mauhq!70!black}{\iconVD Tính chất \themytc}%
}{}
